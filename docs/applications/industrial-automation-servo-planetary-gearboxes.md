...
The [8–42 mm planetary gearbox](../products/planetary-gearboxes/8-42mm-planetary-gear-reducer.md) series provides compact frame sizes for integration with DC, BLDC, stepper, servo or customer-specified motors. Final ratio, torque, efficiency, backlash and dimensions depend on the selected frame size and configuration.
...
For higher-torque rotary axes or compact integrated joint assemblies, SigGear can also evaluate [robot joint actuators](../products/robot-joint-actuators/index.md) and [cycloidal joint modules](../products/cycloidal-joint-modules/index.md) when the application requirements match those product families.
...
[Send Servo Gearbox Requirements](../contact.md){ .md-button .md-button--primary }
