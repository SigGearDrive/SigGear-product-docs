...
![CPM-100-25 cycloidal robot joint module without integrated driver, output-side view](../../assets/images/products/cycloidal-joint-modules/cpm100-25/cpm100-25-no-driver-output-angle.webp)
...
![CPM-100-25 cycloidal joint module without integrated driver, output-side angle](../../assets/images/products/cycloidal-joint-modules/cpm100-25/cpm100-25-no-driver-output-angle.webp)

### Version with integrated driver

![CPM-100-25 cycloidal joint module with integrated driver, output-side angle](../../assets/images/products/cycloidal-joint-modules/cpm100-25/cpm100-25-with-driver-output-angle.webp)
...
- [Humanoid robot joint actuator selection](../../applications/humanoid-robot-joint-actuators.md)
- [Quadruped robot joint gearbox selection](../../applications/quadruped-robot-joint-gearboxes.md)
- [Robotic arm joint actuator selection](../../applications/robotic-arm-joint-actuators.md)
- [Exoskeleton joint actuator selection](../../applications/exoskeleton-joint-actuators.md)
...
To confirm whether CPM-100-25 is suitable, please provide:
